    ...
    getopt.prototype.getHelp = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (short_name && short_name === long_name) {
          ...
          cmdLine = "-" + short_name + ", --" + definition;
        } else {
          cmdLine = "    --" + definition;
        }
        ws[0] = Math.max(ws[0] >> 0, cmdLine.length);
        options.push([cmdLine, comment]);
      }
      strs = (function() {
        ...
        for (_j = 0, _len1 = options.length; _j < _len1; _j++) {
          option = options[_j];
          cmdLine = option[0], comment = option[1];
          while (cmdLine.length < ws[0]) {
            cmdLine += ' ';
          }
          _results.push("  " + cmdLine + "  " + comment);
        }
        return _results;
      })();
